    ...
    <div className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 group">
      ...
      <div className="p-4">
        ...
        <div className="space-y-2">
          <button className="w-full bg-black text-white py-3 px-4 rounded-lg font-medium hover:bg-gray-800 transition-colors duration-200 transform active:scale-98">
            Add to Cart
          </button>
